-- Rydez India: Owner vehicles table with RLS (run in Supabase SQL Editor)
...
-- Storage bucket for vehicle uploads (optional — wrapped so table creation still succeeds)
DO $$
BEGIN
