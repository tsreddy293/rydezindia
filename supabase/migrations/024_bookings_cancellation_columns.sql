...
-- Safe to run on databases that only have legacy cancel_reason / cancelled_at / cancelled_by.
...
-- Backfill new reason column from legacy cancel_reason when present
DO $$
BEGIN
  IF EXISTS (
