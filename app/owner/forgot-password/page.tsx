...
export const metadata = createPageMetadata({
  ...
  description: "Reset your Rydez India owner account password.",
...
export default async function OwnerForgotPasswordPage({ searchParams }: Props) {
    ...
    <PageLayout>
      <div className="mx-auto max-w-md px-4 py-12 md:px-6">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-secondary">Owner Password Reset</h1>
          <p className="text-gray-600 mt-2">Enter your owner email to receive a reset link.</p>
        </div>
        <form action={requestPasswordReset} className="rounded-2xl bg-white border border-gray-100 p-8 shadow-sm space-y-6">
          <input type="hidden" name="loginPath" value="/owner/forgot-password" />
