      ...
      <PageLayout>
        <div className="mx-auto max-w-lg px-4 py-20 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Your vehicle registration is under review. Our team will verify your documents within 24 hours.
          </p>
          <Button href="/owner/dashboard" variant="primary">Go to Dashboard</Button>
        </div>
      </PageLayout>
    );
  }
