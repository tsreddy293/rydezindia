...
export default async function ViewVehiclePage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <Link href="/owner/my-vehicles" className="inline-flex items-center gap-1 text-sm text-primary hover:underline">
        ...
        <div className="space-y-6 p-6 md:p-8">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-gray-500">{vehicle.registration_number}</p>
            </div>
